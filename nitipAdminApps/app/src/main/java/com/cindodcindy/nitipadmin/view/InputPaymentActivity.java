...
public class InputPaymentActivity extends AppCompatActivity {
    ...
    private EditText editText_nama_pengirim, editText_jumlah_uang, editText_nama_bank, editText_tanggal_kirim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_ad_tgal_kirim=findViewById(R.id.tv_add_in_ad_tgal_terima);
        ...
        editText_nama_pengirim=findViewById(R.id.et_add_in_tf_to_sell_nama_pengirim);
        editText_jumlah_uang=findViewById(R.id.et_add_in_tf_to_sell_jumlah_uang);
        editText_nama_bank=findViewById(R.id.et_add_in_tf_to_sell_bank_asal);
        editText_tanggal_kirim=findViewById(R.id.et_add_in_tf_to_sell_tgal_kirim);
